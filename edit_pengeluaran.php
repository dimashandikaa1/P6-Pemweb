...
$data = mysqli_fetch_assoc(
    mysqli_query($conn, "SELECT * FROM pengeluaran WHERE id='$id'")
);

if (!$data) { header("Location: pengeluaran.php"); exit; }
...
<head>
    ...
    <title>Edit Pengeluaran — Sistem Keuangan</title>
...
<div class="page">
    <div class="page-header">
        ...
        <p>Perbarui data pengeluaran yang dipilih</p>
    </div>
